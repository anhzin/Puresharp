...
namespace Puresharp.Discovery
{
    ...
    static public partial class Metadata
    {
        ...
        static public readonly Dictionary<Type> Types = new Dictionary<Type>();
        static public readonly Dictionary<FieldInfo> Fields = new Dictionary<FieldInfo>();
        static public readonly Dictionary<ConstructorInfo> Constructors = new Dictionary<ConstructorInfo>();
        static public readonly Dictionary<MethodInfo> Methods = new Dictionary<MethodInfo>();
        static public readonly Dictionary<PropertyInfo> Properties = new Dictionary<PropertyInfo>();

        static private void Broadcast(object metadata)
        {
            if (metadata is Type) { Metadata.Types.Add(metadata as Type); }
            else if (metadata is FieldInfo) { Metadata.Fields.Add(metadata as FieldInfo); }
            else if (metadata is ConstructorInfo) { Metadata.Constructors.Add(metadata as ConstructorInfo); }
            else if (metadata is MethodInfo) { Metadata.Methods.Add(metadata as MethodInfo); }
            else if (metadata is PropertyInfo) { Metadata.Properties.Add(metadata as PropertyInfo); }
        }
