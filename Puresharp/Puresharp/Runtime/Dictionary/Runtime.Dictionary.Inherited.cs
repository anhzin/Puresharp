...
namespace Puresharp
{
    ...
    static public partial class Runtime<T>
    {
        static internal partial class Dictionary
        {
            static public class Inherited
            {
                static public readonly Data.Collection<FieldInfo> Fields = Runtime.Dictionary.Inherited.Fields[Runtime<T>.Type];
                static public readonly Data.Collection<PropertyInfo> Properties = Runtime.Dictionary.Inherited.Properties[Runtime<T>.Type];
                static public readonly Data.Collection<MethodInfo> Methods = Runtime.Dictionary.Inherited.Methods[Runtime<T>.Type];
            }
        }
    }
}
