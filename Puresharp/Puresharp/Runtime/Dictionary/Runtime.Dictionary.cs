...
namespace Puresharp
{
    ...
    static public partial class Runtime<T>
    {
        static internal partial class Dictionary
        {
            static public readonly Data.Collection<ConstructorInfo> Constructors = Runtime.Dictionary.Constructors[Runtime<T>.Type];
            static public readonly Data.Collection<FieldInfo> Fields = Runtime.Dictionary.Fields[Runtime<T>.Type];
            static public readonly Data.Collection<PropertyInfo> Properties = Runtime.Dictionary.Properties[Runtime<T>.Type];
            static public readonly Data.Collection<MethodInfo> Methods = Runtime.Dictionary.Methods[Runtime<T>.Type];
        }
    }
}
